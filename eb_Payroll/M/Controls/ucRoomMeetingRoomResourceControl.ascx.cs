...
public partial class Controls_ucRoomMeetingRoomResourceControl : System.Web.UI.UserControl
{
    ...
    public object Value
    {
        get
        {
            if (ResourceValue.SelectedValue != "")
            {
    ...
    {
        ResourceValue.Items.Insert(0, new RadComboBoxItem("", ""));
