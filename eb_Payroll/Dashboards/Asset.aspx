...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContentPlaceHolder" runat="Server">
    ...
    <telerik:RadContentTemplateTile runat="server" ID="PendingLeavesTile" Height="130px" Width="308px" CssClass="col-3 col-m-3" Shape="Wide" BackColor="#273033">
        <ContentTemplate>
            <asp:Image runat="server" ImageUrl="../Images/assets/member.png" Height="65px" ImageAlign="AbsMiddle" Style="padding: 10px 0px 0px 20px;" />
    ...
    <telerik:RadContentTemplateTile runat="server" ID="RequestMonthly" Height="130px" Width="227px" CssClass="col-2 col-m-2" Shape="wide" BackColor="#273033">
        <ContentTemplate>
            <div style="text-align: center;">
                <asp:Image runat="server" Height="40px" Style="padding-bottom: 5px;" ImageUrl="../Images/assets/request.png" />
                <div>
                    <telerik:RadLabel runat="server" ID="MonthlyRequests" OnLoad="MonthlyRequestsCount" Font-Size="XX-Large" Style="color: white; padding-bottom: 10px;" />
                </div>
                <div>
                    <label style="color: white; font-size: larger;">Monthly Requests</label></div>
            </div>
        </ContentTemplate>
        <PeekTemplate>
            <div style="text-align: center; background-color: #273033;">
                <asp:Image runat="server" Height="40px" Style="padding-bottom: 5px;" ImageUrl="../Images/assets/request.png" />
                <div>
                    <telerik:RadLabel runat="server" ID="AnnualRequests" OnLoad="AnnualRequestsCount" Font-Size="XX-Large" Style="color: white; padding-bottom: 10px;" />
                </div>
                <div style="padding-bottom: 10px;">
                    <label style="color: white; font-size: larger;">Annual Requests</label></div>
            </div>
        </PeekTemplate>
        <PeekTemplateSettings Animation="slide" HidePeekTemplateOnMouseOut="true" ShowPeekTemplateOnMouseOver="true" />
    </telerik:RadContentTemplateTile>

    <telerik:RadContentTemplateTile runat="server" ID="ApprovedMonthly" Height="130px" Width="227px" CssClass="col-2 col-m-2" Shape="wide" BackColor="#273033">
        <ContentTemplate>
            <div style="text-align: center;">
                ...
                <div>
                    <label style="font-size: larger; color: white;">Monthly Approved</label></div>
            </div>
        </ContentTemplate>
        <PeekTemplate>
            <div style="text-align: center; background-color: #273033;">
    ...
    <telerik:RadContentTemplateTile runat="server" ID="RejectedMonthly" Height="130px" Width="227px" CssClass="col-2 col-m-2" Shape="wide" BackColor="#273033">
        <ContentTemplate>
            <div style="text-align: center;">
                <asp:Image runat="server" Height="40px" Style="padding-bottom: 5px;" ImageUrl="../Images/assets/thumbs-down.png" />
                <div>
                ...
                <div>
                    <label style="font-size: larger; color: white;">Monthly Rejected</label></div>
            </div>
        </ContentTemplate>
        <PeekTemplate>
            <div style="text-align: center; background-color: #273033;">
    ...
    <telerik:RadContentTemplateTile runat="server" ID="TotalEmployee" Shape="Wide" Height="130" Width="308px" CssClass="col-3 col-m-3" BackColor="#273033">
        <ContentTemplate>
            <asp:Image runat="server" ImageUrl="../Images/assets/employee.png" ImageAlign="AbsMiddle" Height="90px" Style="padding: 5px 0px 0px 10px;" />
            <telerik:RadLabel runat="server" ID="EmployeeCount" Font-Bold="false" Font-Size="30px" OnLoad="EmployCount" ForeColor="white" Style="padding-left: 20px;"></telerik:RadLabel>
